...
`DDS-XRCE <https://www.omg.org/spec/DDS-XRCE/About-DDS-XRCE/>`_ (or "DDS for 
eXtremely Resource Constrained Environments") introduces 
...
footprint and network bandwith required by an application to use DDS.
