...
macro(nano_project_vars)
    ...
    set(prj_install_dir_doc     ${prj_install_prefix}doc/${PROJECT_NAME})
    set(prj_install_dir_api_doc ${prj_install_dir_doc}/html)
...
macro(nano_project_doc_vars)
    ...
    set(prj_doc_doxygen_html_dir     ${prj_doc_doxygen_dir}/api)
...
function(nano_project_docs)
    ...
    if(prj_build_docs_api)
        ...
        add_custom_command(OUTPUT ${prj_doc_doxygen_dir}
        ...
        add_custom_target(${prj_doc_tgt}-dox DEPENDS ${prj_doc_doxygen_dir})
        ...
        install(DIRECTORY ${prj_doc_doxygen_html_dir} 
            DESTINATION ${prj_install_dir_api_doc})
    ...
    if(prj_build_docs_man)
        ...
        add_custom_command(OUTPUT ${prj_doc_sources_bin}
            ...
            COMMAND $(CMAKE_COMMAND) -E copy ${prj_doc_build_dir}/sphinx-extlinks.py ${prj_doc_build_dir}/extlinks.py
